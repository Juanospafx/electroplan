...
function exportReport() {
    ...
    const rowsStyled = itemsRows
        .replace(/<tr>/g, '<tr>')
        .replace(/<td>/g, '<td style="border:1px solid #bbb;padding:8px 15px;text-align:left;vertical-align:top;color:#111827;">')
        .replace(/<th>/g, '<th style="border:1px solid #bbb;padding:8px 15px;text-align:left;vertical-align:top;background:#f2f2f2;color:#111827;">');

    const reportHTML = `<div style="padding: 2rem; max-width: 100%; margin: 0 auto; font-family: 'Inter', sans-serif; color:#111827;"><div style="display:flex; justify-content:space-between; align-items:center; border-bottom: 2px solid #333; padding-bottom: 1rem; margin-bottom: 2rem;"><div><h1 style="margin:0; font-size: 1.5rem; color: #1e293b;">Wireway Calculation Report</h1><p style="margin:0.5rem 0 0; color: #64748b;">Generated on ${date}</p></div><div style="text-align:right;"><div style="font-size: 0.8rem; text-transform:uppercase; color: #64748b; font-weight:700;">Total Length</div><div style="font-size: 2.5rem; font-weight: 900; color: #fb5a3a;">${totalVal}"</div><div style="font-size: 1rem; color: #64748b; font-weight:600;">${totalFt}</div></div></div><div style="margin-bottom: 2rem;"><h3 style="color: #475569; border-bottom: 1px solid #e2e8f0; padding-bottom: 0.5rem;">Visual Layout</h3><div style="margin-top: 1rem; padding: 1rem;">${svgContent}</div></div><div><h3 style="color: #475569; border-bottom: 1px solid #e2e8f0; padding-bottom: 0.5rem;">Load Details & Dimensions</h3><table style="width:100%; border-collapse:collapse; margin-top:1.5rem; font-size:10pt;"><thead><tr><th style="border:1px solid #bbb;padding:8px 15px;text-align:left;vertical-align:top;background:#f2f2f2;color:#111827;">Item Type</th><th style="border:1px solid #bbb;padding:8px 15px;text-align:left;vertical-align:top;background:#f2f2f2;color:#111827;">Config</th><th style="border:1px solid #bbb;padding:8px 15px;text-align:left;vertical-align:top;background:#f2f2f2;color:#111827;">Rating/Size</th><th style="border:1px solid #bbb;padding:8px 15px;text-align:left;vertical-align:top;background:#f2f2f2;color:#111827;">Width</th><th style="border:1px solid #bbb;padding:8px 15px;text-align:left;vertical-align:top;background:#f2f2f2;color:#111827;">Gap After</th></tr></thead><tbody>${rowsStyled}</tbody></table></div><div style="margin-top: 4rem; text-align: center; color: #cbd5e1; font-size: 0.8rem;"><p>Brightronix Wireway Calculator</p></div></div>`;
