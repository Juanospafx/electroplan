...
$isProjects  = ($currentScript === 'projects.php' || ($currentScript === 'project_dashboard.php') || ($currentScript === 'index.php' && $pId));
...
<style>
    ...
    .menu-item:hover { 
        ...
        color: var(--primary, #fb5a3a); 
        background: var(--bg-body, #1b212d);
        transform: translateY(-1px);
    }

    .menu-item.active {
        border-color: var(--primary, #fb5a3a);
        color: white;
        background: var(--primary, #fb5a3a);
        box-shadow: 0 4px 15px rgba(251, 90, 58, 0.3);
    }
    ...
    .theme-btn:hover {
        background: var(--border-subtle, #2f384a);
...
<nav class="sidebar" id="mainSidebar">
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 2.5rem; margin-top: 0.5rem; padding-left: 1.5rem; padding-right: 1rem;">
        <a href="../pages/index.php" class="logo-container">
            ...
            <div class="app-subtitle" style="font-size: 0.85rem; color: var(--text-gray, #94a3b8); font-weight: 700; letter-spacing: 0.05em; text-transform: uppercase; margin-top: -0.8rem; margin-left: 0.6rem;">
                Electro Plan
            </div>
        </a>
    ...
    <div class="flex-grow-1 px-4">
        ...
        <?php if ($isAdminSidebar): ?>
            ...
            <a href="../pages/index.php?view=trash" class="menu-item <?= $isTrash ? 'active' : '' ?> text-danger">
                ...
                <span class="menu-label">Recycle Bin</span>
            </a>
        <?php endif; ?>
    </div>
