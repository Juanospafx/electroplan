...
// Agregar estas dos líneas justo antes de: include __DIR__ . '/../views/header.php';
...
.wizard-indicator.active .step-num {
    background: var(--primary);
    border-color: var(--primary);
    color: white;
    box-shadow: 0 0 15px rgba(251,90,58,0.3);
}
.wizard-indicator.completed { color: var(--text-white); }
.wizard-indicator.completed .step-num {
    background: var(--bg-card);
    border-color: var(--primary);
    color: var(--primary);
}
...
<div class="main-content p-4 pt-5">
    ...
    <form id="createProjectForm">
        ...
        <div class="wizard-step" id="step-4">
            <div class="box-card-compact mx-auto text-center py-5" style="max-width: 800px;">
    ...
    document.getElementById('wizard-summary').innerHTML = `
        <div class="row g-4 justify-content-center text-center mb-4">
            <div class="col-md-10">
                ...
                <p class="text-gray small mb-3"><i class="fas fa-map-marker-alt me-1"></i> ${address}</p>
                <div class="p-3 rounded border border-secondary text-start small text-gray" style="background: var(--bg-input);">${desc}</div>
            </div>
        </div>
        ...
        <div class="row g-3 justify-content-center mx-auto" style="max-width: 650px;">
            <div class="col-md-6 text-center">
                <div class="p-3 border border-secondary rounded h-100 position-relative" style="background: var(--bg-input);">
                    ...
                    <div class="text-gray small mb-2 text-uppercase fw-bold">Team & Contacts</div>
            ...
            <div class="col-md-6 text-center">
                <div class="p-3 border border-secondary rounded h-100 position-relative" style="background: var(--bg-input);">
                    ...
                    <div class="text-gray small mb-2 text-uppercase fw-bold">Timeline</div>
            ...
            <div class="col-12 text-center mt-3">
                <div class="p-3 border border-secondary rounded position-relative" style="background: var(--bg-input);">
                    <button type="button" class="btn btn-sm text-gray position-absolute top-0 end-0 m-1" onclick="jumpToStep(3)" title="Edit"><i class="fas fa-pen"></i></button>
                    <div class="text-gray small mb-2 text-uppercase fw-bold">Initial Folders (${foldersList.length})</div>
