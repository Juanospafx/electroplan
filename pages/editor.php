...
<script>
    ...
    function toggleSheets() {
        ...
        updateOverlay();
        // Cerrar herramientas si abrimos sheets en móvil
    ...
    // Auto-mostrar la barra de herramientas al entrar desde un celular (con ligero retraso para permitir renderizado)
